...
heatmap.2(residOrdered[which(rownames(residOrdered) %in% topThy),],labRow=topThyHGNC,trace='n',col=bluered,scale='r',Colv=NULL,ColSideColors=plotCols[as.numeric(metadataMatching$caseStatus[match(colnames(residOrdered),metadataMatching$Px_Code)])],dendrogram = "none",main = "all Thyroid genes correlated with IGF1\nall samples", xlab = "ordered by IGF1 expression")
