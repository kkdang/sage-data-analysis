...
plot(picardGeneMetrics@values$PCT_INTERGENIC_BASES,col = "plum4",pch = 16,type = "o",ylab = "fraction reads", ylim = range(0,1))
lines(picardGeneMetrics@values$PCT_INTRONIC_BASES,col = "slateblue",pch = 16,type = "o")
lines(picardGeneMetrics@values$PCT_UTR_BASES,col = "seagreen3",pch = 16,type = "o")
lines(picardGeneMetrics@values$PCT_CODING_BASES,col = "darkgoldenrod2",pch = 16,type = "o")
lines(picardGeneMetrics@values$PCT_RIBOSOMAL_BASES,col = "orangered",pch = 16,type = "o")
